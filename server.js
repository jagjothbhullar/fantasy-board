...
const initialBoard = [
  ...
  { rank: 49, name: "Marvin Harrison Jr.", pos: "WR", team: "ARI", note: "Generational talent. Year 2 leap expected. Consensus top-25 WR." },
  { rank: 50, name: "Breece Hall", pos: "RB", team: "NYJ", note: "Franchise tagged $14.3M. Locked in as Jets RB1." },
  { rank: 51, name: "Jeremiyah Love", pos: "RB", team: "ROOKIE", note: "🎓 2026 RB1. Three-down workhorse. Projected top-10 pick." },
  { rank: 52, name: "D.K. Metcalf", pos: "WR", team: "PIT", note: "Traded to Steelers. Big-play WR in new home." },
  { rank: 53, name: "Brian Thomas Jr.", pos: "WR", team: "JAX", note: "Breakout WR. Travis Hunter on other side helps." },
  { rank: 54, name: "Travis Etienne Jr.", pos: "RB", team: "NO", note: "🔥 Saints 4yr/$52M. Lead back in New Orleans. RB10 last year.", trend: "up", trendAmt: 17 },
  { rank: 55, name: "Courtland Sutton", pos: "WR", team: "DEN", note: "Nix's top target. R.J. Harvey helps offense." },
  { rank: 56, name: "Mike Evans", pos: "WR", team: "SF", note: "🔥 Signed with 49ers. Ageless WR1 joins CMC + Purdy.", trend: "up", trendAmt: 10 },
  { rank: 57, name: "Zach Charbonnet", pos: "RB", team: "SEA", note: "🔥 Walker gone = SEA RB1! Huge volume boost.", trend: "up", trendAmt: 18 },
  { rank: 58, name: "D'Andre Swift", pos: "RB", team: "CHI", note: "Lead back. DJ Moore gone could shift gameplan." },
  { rank: 59, name: "Michael Pittman Jr.", pos: "WR", team: "PIT", note: "Traded to Steelers. Reunites with Metcalf." },
  { rank: 60, name: "Sam LaPorta", pos: "TE", team: "DET", note: "TE in best offense. High floor." },
  { rank: 61, name: "Quinshon Judkins", pos: "RB", team: "CLE", note: "Sophomore workhorse for Browns." },
  { rank: 62, name: "Jayden Daniels", pos: "QB", team: "WAS", note: "Dual-threat. Year 2 leap with McLaurin." },
  { rank: 63, name: "Emeka Egbuka", pos: "WR", team: "TB", note: "Sophomore WR. Evans departure = WR1 role." },
  ...
  { rank: 69, name: "Tyler Warren", pos: "TE", team: "IND", note: "Sophomore TE on Colts. All-around weapon." },
  { rank: 70, name: "Michael Wilson", pos: "WR", team: "ARI", note: "WR2 next to MHJ. McBride takes TE targets." },
  { rank: 71, name: "Rico Dowdle", pos: "RB", team: "FA", note: "Free agent RB. Could land lead role somewhere." },
  ...
  { rank: 74, name: "Luther Burden III", pos: "WR", team: "CHI", note: "🔥 DJ Moore traded = more targets for Burden.", trend: "up", trendAmt: 6 },
  { rank: 75, name: "Tyler Allgeier", pos: "RB", team: "ARI", note: "Cardinals 2yr/$12.25M. Crowded backfield with Benson/Conner." },
  { rank: 76, name: "David Montgomery", pos: "RB", team: "HOU", note: "🔥 Traded to Texans. Lead back in strong offense.", trend: "up", trendAmt: 10 },
  { rank: 77, name: "Jauan Jennings", pos: "WR", team: "FA", note: "Free agent WR. Produced in SF." },
  { rank: 78, name: "DJ Moore", pos: "WR", team: "BUF", note: "🔥 Traded to Bills. Josh Allen + Moore is dangerous.", trend: "up", trendAmt: 8 },
  { rank: 79, name: "Kyle Pitts", pos: "TE", team: "ATL", note: "🔥 Franchise tagged. Tua arrival = massive unlock.", trend: "up", trendAmt: 8 },
  ...
  { rank: 82, name: "Blake Corum", pos: "RB", team: "LAR", note: "Kyren's backup. Handcuff value in McVay's offense." },
  { rank: 83, name: "Christian Watson", pos: "WR", team: "GB", note: "Boom-bust deep threat for Love." },
  { rank: 84, name: "Jordan Mason", pos: "RB", team: "MIN", note: "Moved to Vikings. Lead back potential." },
  { rank: 85, name: "Ricky Pearsall", pos: "WR", team: "SF", note: "Evans arrival makes him WR2. Still has upside." },
  { rank: 86, name: "Alvin Kamara", pos: "RB", team: "NO", note: "⬇️ Etienne arrival. Could be cut/traded. PPR role shrinks.", trend: "down", trendAmt: 8 },
  { rank: 87, name: "Chuba Hubbard", pos: "RB", team: "CAR", note: "Workhorse volume on weak team." },
  { rank: 88, name: "Chris Godwin", pos: "WR", team: "TB", note: "If healthy, still a PPR monster." },
  { rank: 89, name: "Rachaad White", pos: "RB", team: "FA", note: "⬇️ Left TB. Free agent. Gainwell took his spot.", trend: "down", trendAmt: 5 },
  { rank: 90, name: "Brock Purdy", pos: "QB", team: "SF", note: "🔥 Evans arrival boosts entire offense. Safe QB1 floor.", trend: "up", trendAmt: 5 },
